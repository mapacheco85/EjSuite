...
Namespace EjSuite
    ''' <summary>
    ''' Strongly-typed collection for the VWBuscaProductoCompra class.
    ''' </summary>
    <Serializable()> _
    Public Partial Class VWBuscaProductoCompraCollection 
    Inherits ReadOnlyList(Of VWBuscaProductoCompra, VWBuscaProductoCompraCollection)       
        Public Sub New()
        End Sub
    End Class
    ''' <summary>
    ''' This is  Read-only wrapper class for the EJS_VWBuscaProductoCompra view.
    ''' </summary>
    <Serializable()> _
    Public Partial Class VWBuscaProductoCompra 
    Inherits ReadOnlyRecord(Of VWBuscaProductoCompra)
	    ...
	    Private Shared Sub GetTableSchema()
	        If (Not IsSchemaInitialized) Then
	            'Schema declaration
				Dim schema As TableSchema.Table = New TableSchema.Table("EJS_VWBuscaProductoCompra", TableType.View, DataService.GetInstance("DALEjSuite"))
                ...
                colvarDetalles.MaxLength = 100
                colvarDetalles.AutoIncrement = False
                colvarDetalles.IsNullable = false
                ...
                colvarBEstadoLote.DataType = DbType.Int32
                ...
                DataService.Providers("DALEjSuite").AddSchema("EJS_VWBuscaProductoCompra",schema)
	        End If
	    End Sub
	    #End Region
        ...
        Public Property BEstadoLote() As Integer 
		    Get
			    Return GetColumnValue(Of Integer)("bEstadoLote")
			End Get
            Set(ByVal value As Integer)
