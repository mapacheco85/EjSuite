...
Namespace EjSuite
    ''' <summary>
    ''' Strongly-typed collection for the VwDeudas1 class.
    ''' </summary>
    <Serializable()> _
    Public Partial Class VwDeudas1Collection 
    Inherits ReadOnlyList(Of VwDeudas1, VwDeudas1Collection)       
        Public Sub New()
        End Sub
    End Class
    ''' <summary>
    ''' This is  Read-only wrapper class for the EJS_VwDeudas1 view.
    ''' </summary>
    <Serializable()> _
    Public Partial Class VwDeudas1 
    Inherits ReadOnlyRecord(Of VwDeudas1)
	    ...
	    Private Shared Sub GetTableSchema()
	        If (Not IsSchemaInitialized) Then
	            'Schema declaration
				Dim schema As TableSchema.Table = New TableSchema.Table("EJS_VwDeudas1", TableType.View, DataService.GetInstance("DALEjSuite"))
                ...
                DataService.Providers("DALEjSuite").AddSchema("EJS_VwDeudas1",schema)
	        End If
	    End Sub
	    #End Region
