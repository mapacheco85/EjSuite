...
Namespace EjSuite
	''' <summary>
	''' Strongly-typed collection for the Detalle class.
	''' </summary>
	<Serializable> _
	Public Partial Class DetalleCollection 
	Inherits ActiveList(Of Detalle, DetalleCollection)
	    Public Sub New()
		End Sub
		
		Public Function Filter() As DetalleCollection
			For i As Integer = Me.Count - 1 To 0 Step -1
				Dim o As Detalle = Me(i)
	...
	End Class
	''' <summary>
	''' This is an ActiveRecord class which wraps the EJS_Detalle table.
	''' </summary>
	<Serializable> _
	Public Partial Class Detalle 
	Inherits ActiveRecord(Of Detalle)
		...
		Private Shared Sub GetTableSchema()
			If (Not IsSchemaInitialized) Then
				'Schema declaration
				Dim schema As TableSchema.Table = New TableSchema.Table("EJS_Detalle", TableType.Table, DataService.GetInstance("DALEjSuite"))
				schema.Columns = New TableSchema.TableColumnCollection()
				schema.SchemaName = "dbo"
				'columns
				
                
                Dim colvarNCodDetalle As TableSchema.TableColumn = New TableSchema.TableColumn(schema)
                colvarNCodDetalle.ColumnName = "nCodDetalle"
                colvarNCodDetalle.DataType = DbType.Int32
                colvarNCodDetalle.MaxLength = 0
                colvarNCodDetalle.AutoIncrement = false
                colvarNCodDetalle.IsNullable = false
                colvarNCodDetalle.IsPrimaryKey = true
                colvarNCodDetalle.IsForeignKey = false
                colvarNCodDetalle.IsReadOnly = false
                
                
                schema.Columns.Add(colvarNCodDetalle)
                ...
                colvarNcodFactura.IsForeignKey = true
                colvarNcodFactura.IsReadOnly = false
                
                
				colvarNcodFactura.ForeignKeyTableName = "EJS_Factura"
                ...
                DataService.Providers("DALEjSuite").AddSchema("EJS_Detalle",schema)
			End If
		End Sub
        ...
        <Bindable(True)> _  
        <XmlAttribute("NCodDetalle")> _
        Public Property NCodDetalle As Integer 
			Get
				Return GetColumnValue(Of Integer)(Columns.NCodDetalle)
			End Get
		    
			Set
				SetColumnValue(Columns.NCodDetalle, Value)
			End Set
		End Property
		...
		''' <summary>
		''' Returns a Factura ActiveRecord object related to this Detalle
		''' </summary>
		Public Property Factura() As EjSuite.Factura
			Get
				Return EjSuite.Factura.FetchByID(Me.NcodFactura)
			End Get
			Set
				SetColumnValue("ncodFactura", Value.NCodFactura)
			End Set
		End Property
	    
		''' <summary>
		''' Returns a Producto ActiveRecord object related to this Detalle
		''' </summary>
		...
		''' </summary>
		Public Shared Sub Insert(ByVal varNCodDetalle As Integer,ByVal varNCodProducto As Nullable(Of Integer),ByVal varNcodFactura As Long,ByVal varNCantidad As Integer,ByVal varNPrecioUnitario As Decimal,ByVal varNDescuento As Decimal,ByVal varBUnidad As Boolean,ByVal varBDocena As Boolean,ByVal varBCien As Boolean,ByVal varBMil As Boolean)
			Dim item As Detalle = New Detalle()
			
            item.NCodDetalle = varNCodDetalle
		...
		''' </summary>
		Public Shared Sub Update(ByVal varNCodDetalle As Integer,ByVal varNCodProducto As Nullable(Of Integer),ByVal varNcodFactura As Long,ByVal varNCantidad As Integer,ByVal varNPrecioUnitario As Decimal,ByVal varNDescuento As Decimal,ByVal varBUnidad As Boolean,ByVal varBDocena As Boolean,ByVal varBCien As Boolean,ByVal varBMil As Boolean)
			Dim item As Detalle = New Detalle()
        ...
        Public Shared ReadOnly Property NCodDetalleColumn() As TableSchema.TableColumn
            Get
		...
		Public Structure Columns
            ...
            Public Shared NCodDetalle As String = "nCodDetalle"
