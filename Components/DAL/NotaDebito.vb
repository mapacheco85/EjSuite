...
Namespace EjSuite
	''' <summary>
	''' Strongly-typed collection for the NotaDebito class.
	''' </summary>
	<Serializable> _
	Public Partial Class NotaDebitoCollection 
	Inherits ActiveList(Of NotaDebito, NotaDebitoCollection)
	    Public Sub New()
		End Sub
		
		Public Function Filter() As NotaDebitoCollection
			For i As Integer = Me.Count - 1 To 0 Step -1
				Dim o As NotaDebito = Me(i)
	...
	End Class
	''' <summary>
	''' This is an ActiveRecord class which wraps the EJS_NotaDebito table.
	''' </summary>
	<Serializable> _
	Public Partial Class NotaDebito 
	Inherits ActiveRecord(Of NotaDebito)
		...
		Private Shared Sub GetTableSchema()
			If (Not IsSchemaInitialized) Then
				'Schema declaration
				Dim schema As TableSchema.Table = New TableSchema.Table("EJS_NotaDebito", TableType.Table, DataService.GetInstance("DALEjSuite"))
				schema.Columns = New TableSchema.TableColumnCollection()
				schema.SchemaName = "dbo"
				'columns
				
                
                Dim colvarNCodNotaDebito As TableSchema.TableColumn = New TableSchema.TableColumn(schema)
                colvarNCodNotaDebito.ColumnName = "nCodNotaDebito"
                colvarNCodNotaDebito.DataType = DbType.Int32
                colvarNCodNotaDebito.MaxLength = 0
                colvarNCodNotaDebito.AutoIncrement = false
                colvarNCodNotaDebito.IsNullable = false
                colvarNCodNotaDebito.IsPrimaryKey = true
                colvarNCodNotaDebito.IsForeignKey = false
                colvarNCodNotaDebito.IsReadOnly = false
                
                
                schema.Columns.Add(colvarNCodNotaDebito)
                ...
                DataService.Providers("DALEjSuite").AddSchema("EJS_NotaDebito",schema)
			End If
		End Sub
        ...
        <Bindable(True)> _  
        <XmlAttribute("NCodNotaDebito")> _
        Public Property NCodNotaDebito As Integer 
			Get
				Return GetColumnValue(Of Integer)(Columns.NCodNotaDebito)
			End Get
		    
			Set
				SetColumnValue(Columns.NCodNotaDebito, Value)
			End Set
		End Property
		...
		''' <summary>
		''' Returns a OrdenCompra ActiveRecord object related to this NotaDebito
		''' </summary>
		...
		''' </summary>
		Public Shared Sub Insert(ByVal varNCodNotaDebito As Integer,ByVal varDFecha As String,ByVal varNCodCliente As Integer,ByVal varNCodUsuario As Integer,ByVal varDFechaRegistro As String,ByVal varNCodPedido As Nullable(Of Integer),ByVal varNCodVendedor As String,ByVal varNValorPedido As Decimal)
			Dim item As NotaDebito = New NotaDebito()
			
            item.NCodNotaDebito = varNCodNotaDebito
		...
		''' </summary>
		Public Shared Sub Update(ByVal varNCodNotaDebito As Integer,ByVal varDFecha As String,ByVal varNCodCliente As Integer,ByVal varNCodUsuario As Integer,ByVal varDFechaRegistro As String,ByVal varNCodPedido As Nullable(Of Integer),ByVal varNCodVendedor As String,ByVal varNValorPedido As Decimal)
			Dim item As NotaDebito = New NotaDebito()
        ...
        Public Shared ReadOnly Property NCodNotaDebitoColumn() As TableSchema.TableColumn
            Get
		...
		Public Structure Columns
            ...
            Public Shared NCodNotaDebito As String = "nCodNotaDebito"
