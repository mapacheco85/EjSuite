<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ClienteControl.ascx.vb"
    Inherits="EjSuite.Modules.EjSuite.ClienteControl" %>
...
<asp:Panel ID="pnlSearchModal" Style="display: none; background-color: InfoBackground;"
    runat="server" DefaultButton="cmdBuscarCliente">
    <asp:UpdatePanel ID="upsearchModal" runat="server" UpdateMode="Conditional" RenderMode="Inline">
        <ContentTemplate>
            <fieldset id="fsContactSearch" runat="server">
                <legend>
                    <asp:Label ID="lblLinea" runat="server" Text="Buscar Cliente" Font-Bold="True" />
                </legend>
                <table border="0" style="width: 100%; padding: 0px; border-spacing: 0px;">
                    <tr>
                        <td style="width: 150px" class="SubHead">
                            <dnn:label ID="plnombres" runat="server" ControlName="txtBusqueda" Suffix=":" Text="Cliente" />
                        </td>
                        <td>
                            <asp:TextBox ID="txtBusqueda" runat="server" EnableViewState="False" Width="100%" />
                            <br />
                            <asp:LinkButton ID="cmdBuscarCliente" runat="server" Text="Buscar" CssClass="CommandButton"
                                CausesValidation="False" />&nbsp;
                                        <asp:HyperLink ID="hypAdminEmpresa" runat="server" Target="_blank" Font-Italic="False">&nbsp;
                                            Gestionar clientes</asp:HyperLink>&nbsp;
                    ...
                    <tr>
                        <td colspan="2">
                            <asp:Label ID="lblSearchResults" runat="server" Font-Bold="True"
                            ...
                            <div style="width: 100%; height: 250px; overflow: scroll">
                                <asp:GridView ID="grdClientes" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Cod. Cliente" ItemStyle-HorizontalAlign="Right">
