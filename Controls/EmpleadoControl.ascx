<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="EmpleadoControl.ascx.vb"
    Inherits="EjSuite.Modules.EjSuite.EmpleadoControl" %>
                ...
                <table style="width: 100%; border: 0px; padding: 0px; border-spacing: 0px;">
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:HyperLink ID="hypAdminEmpresa" runat="server" Target="_blank">Gestionar Empleados
                            </asp:HyperLink>&nbsp;
