<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ProductoControl.ascx.vb"
    Inherits="EjSuite.Modules.EjSuite.ProductoControl" %>
                ...
                <table style="width: 100%; border: 0px; padding: 0px; border-spacing: 0px;">
                    <tr>
                        <td style="width: 150px" class="SubHead">
                            <dnn:label ID="plProducto" runat="server" ControlName="txtBusqueda"
                        ...
                        <td>
                            ...
                            <asp:HyperLink ID="hypAdminEmpresa" runat="server" Target="_blank"
                                Font-Italic="False">Gestionar Productos</asp:HyperLink>&nbsp;
                        ...
                        <td colspan="2">
                            ...
                            <div style="width: 100%; height: 250px; overflow: scroll">
                                <asp:GridView ID="grdProductos" runat="server" AutoGenerateColumns="False"
                                    EmptyDataText="No se encontraron registros." CssClass="Normal"
