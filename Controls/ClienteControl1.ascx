<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ClienteControl1.ascx.vb"
    Inherits="EjSuite.Modules.EjSuite.ClienteControl1" %>
...
<asp:Panel ID="pnlSearchModal" Style="display: none; background-color: InfoBackground;"
    runat="server" DefaultButton="cmdBuscarCliente1">
    <asp:UpdatePanel ID="upsearchModal" runat="server" UpdateMode="Conditional" RenderMode="Inline">
        <ContentTemplate>
            <fieldset id="fsContactSearch" runat="server">
                <legend>
                    <asp:Label ID="lblLinea" runat="server" Text="Buscar Cliente"  />
                </legend>
                <table border="0" style="width: 100%; padding: 0px; border-spacing: 0px;">
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:LinkButton ID="cmdBuscarCliente1" runat="server" Text="Buscar" CssClass="CommandButton"
                                CausesValidation="False" />&nbsp;
                            <asp:HyperLink ID="hypAdminEmpresa" runat="server" Target="_blank"
                                Font-Italic="False">Gestionar Clientes</asp:HyperLink>&nbsp;
                    ...
                    <tr>
                        <td colspan="2">
                            <asp:Label ID="lblSearchResults" runat="server" Style="font-weight: 700"></asp:Label>
