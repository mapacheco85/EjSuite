...
Namespace EjSuite.Modules.EjSuite
    Public Class ClienteControl
        ...
        Public Sub BuscarCliente()
            ...
            ds = SPs.VerDatosCliente(Trim(Me.txtBusqueda.Text)).GetDataSet()
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            If Not IsPostBack Then
                ...
                param(0) = "mid=" & modID
                param(1) = "EjSuiteSubControl=Beneficiarios"
                Dim urlDoc As String = NavigateURL(tabID, "EjSuiteSub", param)
                'Dim urlDoc As String = EditUrl("EjSuiteSubControl", "Beneficiarios", "EjSuiteSub")
        ...
        Protected Sub cmdSearch_Click(ByVal sender As Object, ByVal e As EventArgs) Handles cmdBuscarCliente.Click
            BuscarCliente()
        End Sub
        ...
        Protected Sub grdClientes_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles grdClientes.RowCommand
            Select Case e.CommandName.ToLower()
                Case "clienteselect"
                    Dim mye As New ClienteSelectedEventArgs() With {.SelectedCliente = CStr(e.CommandArgument)}
        ...
        Public Event ClienteSelected(ByVal sender As Object, ByVal e As ClienteSelectedEventArgs)

    End Class

    Public Class ClienteSelectedEventArgs
        Inherits EventArgs
        Public Sub New()
