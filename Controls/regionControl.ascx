<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="regionControl.ascx.vb"
    Inherits="EjSuite.Modules.EjSuite.regionControl" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Register TagPrefix="dnn" TagName="label" Src="~/Controls/LabelControl.ascx" %>
<asp:ImageButton ID="lbnElegirR" runat="server" EnableViewState="false"
                ...
                <table style="width:100%; border: 0px; padding: 0px; border-spacing: 0px;">
                    <tr>
                        <td style="width: 150px" class="SubHead">
                            <dnn:label ID="plSucursal" runat="server" ControlName="txtBusquedaR" Suffix=":" Text="Sucursal" />
                        </td>
                        <td>
                            <asp:TextBox ID="txtBusquedaR" runat="server" EnableViewState="False" Width="100%" /><br />
                            <asp:LinkButton ID="cmdSearch" runat="server" Text="Buscar" CssClass="CommandButton"
                                CausesValidation="False" />&nbsp;
                                        <asp:HyperLink ID="hypAdminEmpresa" runat="server" Target="_blank"
                                            Font-Italic="False">Gestionar Sucursal</asp:HyperLink>&nbsp;
                                        <asp:LinkButton ID="cmdCancelR" runat="server" Text="Cancelar" CssClass="CommandButton"
                                            CausesValidation="False" />
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            ...
                            <div style="width: 100%; height: 250px; overflow: scroll">
                                <asp:GridView ID="grdRegion" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Agencia" ItemStyle-HorizontalAlign="Center">
