<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="EjSuiteTotalCompraCliente1.ascx.vb"
    Inherits="EjSuite.Modules.EjSuite.EjSuiteTotalCompraCliente1" %>
        ...
        <table style="background-color: rgba(204, 204, 204, 0.5); width: 100%; border: 0px; padding: 5px;  border-spacing: 5px;">
            <tr>
                <td style="text-align: center;">
                    <asp:LinkButton ID="lbtn1" runat="server" CssClass="ig_Button" CausesValidation="False">Reporte Cantidad Productos vendidos</asp:LinkButton>
                </td>
            </tr>
        </table>
                        ...
                        <td colspan="2">
                            ...
                            <div style="width: auto; height: 300px; overflow: scroll">
                                <asp:GridView ID="grdRepSucursal" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    CssClass="Locked" BackColor="White" BorderColor="#3366CC" BorderStyle="None"
                                    ...
                                    <FooterStyle BackColor="#99CCCC" ForeColor="#003399" BorderColor="#009933" BorderStyle="Double"
                                        Font-Size="Large" />
                                    <Columns>
                                        <asp:BoundField DataField="nCodCliente" HeaderText="CLIENTE ID" HeaderStyle-ForeColor="White"
                                             ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
                                        <asp:BoundField DataField="CLIENTE" HeaderText="RAZON SOCIAL" HeaderStyle-ForeColor="White"
                                             ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
                                        ...
                                        <asp:BoundField DataField="EMITIDA" HeaderText="EMITIDA" HeaderStyle-ForeColor="White"
                                             ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
                                        <asp:BoundField DataField="TOTALCANTIDAD" HeaderText="CANTIDAD" HeaderStyle-ForeColor="White"
                                             ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
