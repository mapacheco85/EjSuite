<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="EjSuitePago1.ascx.vb"
    Inherits="EjSuite.Modules.EjSuite.EjSuitePago1" %>
        ...
        <table style="background-color: rgba(204, 204, 204, 0.5); width: 100%; border: 0px; padding: 5px;  border-spacing: 5px;">
            <tr>
                <td style="text-align: center;">
                    <asp:LinkButton ID="lbtn1" runat="server" CssClass="ig_Button" CausesValidation="False">Reporte Pago</asp:LinkButton>
                </td>
            </tr>
        </table>
                        ...
                        <td colspan="2">
                            ...
                            <div style="width: auto; height: 300px; overflow: scroll">
                                <asp:GridView ID="grdRepSucursal" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ...
                                    <FooterStyle ForeColor="#003399" BorderColor="#009933" BorderStyle="Double" Font-Size="Large"
                                        BackColor="#99CCCC" />
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="CLIENTE" HeaderText="RAZON SOCIAL" HeaderStyle-ForeColor="White"
                                             ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
                                        <asp:BoundField DataField="EMITIDA" HeaderText="FECHA EMISION" HeaderStyle-ForeColor="White"
                                             ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
                                        <asp:BoundField DataField="NUMERO" HeaderText="NUMERO" HeaderStyle-ForeColor="White"
                                             ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
                                        <asp:BoundField DataField="TOTALPAGADO" HeaderText="PAGADO" DataFormatString="{0:F}"
                                             ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
