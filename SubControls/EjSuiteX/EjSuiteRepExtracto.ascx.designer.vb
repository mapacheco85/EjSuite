...
Namespace EjSuite.Modules.EjSuite
    ...
    Partial Public Class EjSuiteRepExtracto
        ...
        '''<summary>
        '''Control cmdSearchExtracto.
        '''</summary>
        '''<remarks>
        '''Campo generado automáticamente.
        '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
        '''</remarks>
        Protected WithEvents cmdSearchExtracto As Global.System.Web.UI.WebControls.Button

        '''<summary>
        '''Control cmdCancelExtracto.
        '''</summary>
        '''<remarks>
        '''Campo generado automáticamente.
        '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
        '''</remarks>
        Protected WithEvents cmdCancelExtracto As Global.System.Web.UI.WebControls.Button

        '''<summary>
        '''Control lblMessageExtracto.
        '''</summary>
        '''<remarks>
        '''Campo generado automáticamente.
        '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
        '''</remarks>
        Protected WithEvents lblMessageExtracto As Global.System.Web.UI.WebControls.Label

        '''<summary>
        '''Control grdRepExtracto.
        '''</summary>
        '''<remarks>
        '''Campo generado automáticamente.
        '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
        '''</remarks>
        Protected WithEvents grdRepExtracto As Global.System.Web.UI.WebControls.GridView
