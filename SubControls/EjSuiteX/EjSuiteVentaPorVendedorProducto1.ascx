<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="EjSuiteVentaPorVendedorProducto1.ascx.vb"
    Inherits="EjSuite.Modules.EjSuite.EjSuiteVentaPorVendedorProducto1" %>
        ...
        <table style="background-color: rgba(204, 204, 204, 0.5); width: 100%; border: 0px; padding: 5px;  border-spacing: 5px;">
            <tr>
                <td style="text-align: center;">
                    <asp:LinkButton ID="lbtn1" runat="server" CssClass="ig_Button" CausesValidation="False">Reporte Ventas Por Vendedor Por Producto</asp:LinkButton>
                </td>
            </tr>
        </table>
                    ...
                    <tr>
                        <td colspan="2">
                            <asp:DropDownList ID="DropDownList1" runat="server">
                                <asp:ListItem Value="JOSE LUIS ARRATIA"></asp:ListItem>
                                <asp:ListItem Value="Mabel Aruni"></asp:ListItem>
                                <asp:ListItem Value="Alexis Franco"></asp:ListItem>
                                <asp:ListItem Value="cecilia pacheco"></asp:ListItem>
                            </asp:DropDownList>
                            <br />
                            ...
                            <div style="width: auto; height: 300px; overflow: scroll">
                                <asp:GridView ID="grdRepSucursal" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="nCodFactura" HeaderText="ID FACTURA" HeaderStyle-ForeColor="White"
                                             ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center"  />
                                        <asp:BoundField DataField="EMPLEADOID" HeaderText="ID EMPLEADO" HeaderStyle-ForeColor="White"
                                             ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center"  />
                                        ...
                                        <asp:BoundField DataField="VENDEDOR" HeaderText="VENDEDOR" HeaderStyle-ForeColor="White"
                                             ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
                                        <asp:BoundField DataField="FECHAEMISION" HeaderText="EMITIDA" HeaderStyle-ForeColor="White"
                                             ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center"  />
                                        <asp:BoundField DataField="PRODUCTO" HeaderText="PRODUCTO" HeaderStyle-ForeColor="White"
                                             ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center"  />
                                        <asp:BoundField DataField="CANTIDAD" HeaderText="CANTIDAD" HeaderStyle-ForeColor="White"
                                             ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center"  />
                                        <asp:BoundField DataField="TOTAL" HeaderText="TOTAL" DataFormatString="{0:F}" HeaderStyle-ForeColor="White"
                                             ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center"  />
                                    </Columns>
                            ...
                            <div style="width: auto; height: 300px; overflow: scroll">
                                <asp:GridView ID="grdVendedor" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="CANTIDAD" HeaderText="CANTIDAD" HeaderStyle-ForeColor="White" 
                                            ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
                                        <asp:BoundField DataField="TOTAL" HeaderText="MONTO TOTAL" DataFormatString="{0:F}"
