...
Namespace EjSuite.Modules.EjSuite
    Public Class EjSuiteDeudamayormil1
        ...
        Private Sub Cargar()
            ...
            End If
            qry.And(VwDeudasReporte.Columns.Deuda).IsGreaterThan(1000)
        ...
        Protected Sub lbtnExportarExcel_Click(ByVal sender As Object, ByVal e As EventArgs) Handles lbtnExportarExcel.Click
            If grdRepSucursal.Rows.Count > 0 Then
                GridViewExportUtil.Export("Deudaclientemayoramil.xlsx", grdRepSucursal)
            End If
        End Sub
