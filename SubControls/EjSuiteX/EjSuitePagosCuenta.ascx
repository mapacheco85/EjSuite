<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="EjSuitePagosCuenta.ascx.vb"
	Inherits="EjSuite.Modules.EjSuite.EjSuitePagosCuenta" %>
	...
	<ContentTemplate>
		<table style="background-color: rgba(204, 204, 204, 0.5); width: 100%; border: 0px; padding: 5px;  border-spacing: 5px;">
			<tr>
				<td style="text-align: center;">
					<asp:LinkButton ID="lbtn1" runat="server" CssClass="ig_Button" CausesValidation="False">Nuevo Pago(Efectivo)</asp:LinkButton>
				</td>
				<td style="text-align: center;">
					<asp:LinkButton ID="lbtn2" runat="server" CssClass="ig_Button" CausesValidation="False">Búsqueda de Pagos(Efectivo)</asp:LinkButton>
				</td>
			</tr>
		</table>
		<br />
		<asp:Panel ID="pnlPagos" runat="server">
			...
			<table style="width: 100%; height: 19px; border: 0px; padding: 0px; border-spacing: 0px;">
				<tr>
					<td class="SubHead">
						<asp:Label ID="lblMessagePagos" runat="server" ForeColor="#CC3300"></asp:Label>
					</td>
				</tr>
			</table>
			...
			<fieldset id="panelbusPago" runat="server" style="width: 100%">
				<table style="width: 100%; border: 0px; padding: 0px; border-spacing: 0px;">
					...
					<tr>
						...
						<td style="width: 120px; vertical-align: top;" class="SubHead">
							<ig:WebDatePicker ID="txtInicio" runat="server" Culture="es-BO" 
								DisplayModeFormat="d" Nullable="False" OpenCalendarOnFocus="True" SelectionOnFocus="NotSet">
					...
					<tr>
						...
						<td style="width: 120px; vertical-align: top;" class="SubHead">
							<ig:WebDatePicker ID="txtFinal" runat="server" Culture="es-BO" 
								DisplayModeFormat="d" Nullable="False" OpenCalendarOnFocus="True">
								<Buttons SpinButtonsDisplay="OnRight">
								</Buttons>
							</ig:WebDatePicker>
						</td>
				...
				<table style="width: 100%; border: 0px; padding: 0px; border-spacing: 0px;">
					...
					<tr>
						...
						<td style="vertical-align: top;">
							...
							<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtFechaPago1"
								Display="None" ErrorMessage="Ingrese la fecha de pago" SetFocusOnError="True"></asp:RequiredFieldValidator>
					...
					<tr>
						...
						<td style="vertical-align: top;">
							...
							<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtMontoPago1"
								Display="None" ErrorMessage="Ingrese el monto de pago" SetFocusOnError="True"></asp:RequiredFieldValidator>
