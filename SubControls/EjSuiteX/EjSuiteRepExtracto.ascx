<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="EjSuiteRepExtracto.ascx.vb"
    Inherits="EjSuite.Modules.EjSuite.EjSuiteRepExtracto" %>
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <div style="width: 100%; height: 500px; overflow: scroll">
                                <asp:GridView ID="grdRepExtracto" runat="server" AutoGenerateColumns="False" Width="100%"
