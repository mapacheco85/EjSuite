<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="EjSuiteVentasPorZona.ascx.vb"
    Inherits="EjSuite.Modules.EjSuite.EjSuiteVentasPorZona" %>
                        ...
                        <td colspan="2">
                            ...
                            <div style="width: auto; height: 300px; overflow: scroll">
                                <asp:GridView ID="grdRepSucursal" runat="server" AutoGenerateColumns="False" CssClass="Normal"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="NIT" HeaderText="DIRECCION" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
                                        <asp:BoundField DataField="cliente" HeaderText="TELEFONO" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
                                        <asp:BoundField DataField="NUMERO" HeaderText="VENDEDOR" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
                                    ...
                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" BackColor="#003399"
