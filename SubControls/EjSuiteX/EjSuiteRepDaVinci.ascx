<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="EjSuiteRepDaVinci.ascx.vb"
    Inherits="EjSuite.Modules.EjSuite.EjSuiteRepDaVinci" %>
        ...
        <table style="background-color: rgba(204, 204, 204, 0.5); width: 100%; border: 0px; padding: 5px;  border-spacing: 5px;">
            <tr>
                <td style="text-align: center;">
                    <asp:LinkButton ID="lbtn1" runat="server" CssClass="ig_Button" CausesValidation="False">Reporte de Facturación</asp:LinkButton>
                </td>
            </tr>
        </table>
